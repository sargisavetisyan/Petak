...
import StyleCategorys from './Categorys.module.scss';
...
export const Categorys = React.memo(() => {
    ...
    return (
        <div className={StyleCategorys.categorys}>
            <Container>
                <NavbarPage />
                <div className={StyleCategorys.body}>
                    <div className={StyleCategorys.forms}>
                        <Situation
                            path={path}
                        />
                        <Form className={StyleCategorys.operations}>
                            {operations.map((operation, i) => {
                                if (operation !== 'Ads with photos') {
                                    return (
                                        <Form.Group
                                            key={i}
                                            className={StyleCategorys.item}
                                        >
                                            <Form.Check
                                                inline
                                                label={operation}
                        ...
                        <Accordion alwaysOpen className={StyleCategorys.acardion}>
                                ...
                                if (dataRegionsCursPriceCategory.name === 'Location') {
                                    return (
                                        <Form
                                            style={{ height: `${heigth}` }}
                                            key={i}
                                            className={StyleCategorys.locations}
                                        >
                                            <Accordion.Item eventKey={i} className={StyleCategorys.acardionItem}>
                                                <Accordion.Header onClick={location}>{dataRegionsCursPriceCategory.name}</Accordion.Header>
                                                <Accordion.Body>
                                                    <Form.Group className={StyleCategorys.item} >
                                                        <Form.Check
                                                            inline
                                                            label='All'
                                                            name="group3"
                                                    ...
                                                    {dataRegionsCursPriceCategory.elements.map((element, index) => {
                                                            ...
                                                            return (
                                                                <Fragment key={index}>
                                                                    ...
                                                                    {element.regions.map((region, ind) => {
                                                                        return (
                                                                            <div key={ind} className={StyleCategorys.itemRegion}>
                                                                                {region}
                                                                            </div>
                                                                        )
                                                                    })}
                                                        ...
                                                        if (element.active) {
                                                            ...
                                                            return (
                                                                <Form.Group key={index} className={StyleCategorys.item} >
                                                                    <Form.Check
                                                                        inline
                                                                        label={element.name}
                                                                        name="group3"
                                    ...
                                    return (
                                        <Form key={i} className={StyleCategorys.currency}>
                                            <Accordion.Item eventKey={i} className={StyleCategorys.acardionItem}>
                                    ...
                                    return (
                                        <Form key={i} className={StyleCategorys.price}>
                                            <Accordion.Item eventKey={i} className={StyleCategorys.acardionItem}>
                                                <Accordion.Header>{dataRegionsCursPriceCategory.name}</Accordion.Header>
                                                <Accordion.Body>
                                                    {simbol && <Form.Label className={StyleCategorys.priceList}>{price}{simbol}-{max}{simbol}</Form.Label>}
                                                    <Slider
                                                        min={0}
                                                        max={max}
                                                        step={step}
                                    ...
                                    return (
                                        <Form key={i} className={StyleCategorys.category} >
                                            <Accordion.Item eventKey={i} className={StyleCategorys.acardionItem} onClick={closeSwiper}>
                                                <Accordion.Header>{dataRegionsCursPriceCategory.name}</Accordion.Header>
                                                <Accordion.Body>
                                                    {dataRegionsCursPriceCategory.elements.map((el, index) => {
                                                        return (
                                                            <div key={index} className={StyleCategorys.content}>
                                                                <div className={StyleCategorys.title}>{el.name}</div>
                                                                <div className={StyleCategorys.items}>
                        ...
                        {!close &&
                            <div className={StyleCategorys.swiper}>
                                <Swiper
